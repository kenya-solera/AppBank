...
public class TC_03_001 extends InitiateDriverTransaction {
    ...
    @Test
    public void test_03_001_DataLoadingFromDatabase(){
    ...
    @Test
    public void test_03_002_Transactions_inFriends_Different_From_Everyone(){
    ...
    @Test
    public void test_03_003_Transactions_inFriends_Different_From_Mine() {
        driver.findElement(By.cssSelector(".MuiButtonBase-root:nth-child(2)")).click();
        String textInFriends = driver.findElement(By.cssSelector(".MuiTableRow-root:nth-child(1) > .MuiTableCell-body:nth-child(2)")).getText();
    ...
    @Test
    public void test_03_004_Transactions_in_Mine_Different_From_Everyone() {
